...
@Composable
internal fun rememberPhysicalActivityMarker(colorMarkerGuideLine: Color): Marker {
    ...
    return remember(label, indicator, guideline) {
        object : MarkerComponent(label, indicator, guideline) {
            init {
                ...
                this.labelFormatter = MyPhysicalActivityMarkerLabelFormatter
...
public object MyPhysicalActivityMarkerLabelFormatter : MarkerLabelFormatter {

    private const val PATTERN = "%.0f steps"
